...
birdcubeflanders <- occ_download_get(birdcubeflanders_year, overwrite = TRUE) |>
  occ_download_import()

write.csv(birdcubeflanders, "../data/interim/birdcubeflanders.csv")
```
...
abv_data <- occ_download_get(abv_data_down, overwrite = TRUE) |>
  occ_download_import()
