...
par(mfrow = c(3, 2), mar = c(4, 4, 3, 1))  # Layout + margins

# ----------- Positive Correlation -----------
# Time series
plot(data1_pos, type = "l", col = "#1B9E77", lwd = 2, ylim = range(c(data1_pos, data2_pos)),
     ylab = "Value", xlab = "Time", main = "Two trends with positive correlation")
lines(data2_pos, col = "#D95F02", lwd = 2)
legend("topleft", legend = c("Data 1", "Data 2"), col = c("#1B9E77", "#D95F02"), lwd = 2)
...
# ----------- No Correlation -----------
plot(data1_none, type = "l", col = "#1B9E77", lwd = 2, ylim = range(c(data1_none, data2_none)),
     ylab = "Value", xlab = "Time", main = "Two trends with no correlation")
...
plot(data1_neg, type = "l", col = "#1B9E77", lwd = 2, ylim = range(c(data1_neg, data2_neg)),
     ylab = "Value", xlab = "Time", main = "Two trends with negative correlation")
