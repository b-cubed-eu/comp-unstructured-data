---
title: "Download and prepare ABV and cube data at 5km² grid"
...
> GBIF.org (24 March 2025) GBIF Occurrence Download https://doi.org/10.15468/dl.s9wnzu
...
> GBIF.org (24 March 2025) GBIF Occurrence Download https://doi.org/10.15468/dl.qz5s7x
...
write_csv(abv_data_out,
          file.path(out_path, "abv_data_cube_5km.csv"))
write_csv(sampling_framework_out,
          file.path(out_path, "sampling_framework_abv_5km.csv"))

## Spatial object
write_sf(abv_data_out_sf,
         file.path(out_path, "abv_data_cube_5km.gpkg"))
write_sf(sampling_framework_out_sf,
         file.path(out_path, "sampling_framework_abv_5km.gpkg"))

# Unstructured data
## CSV
write_csv(birdcube_data_out,
          file.path(out_path, "birdcubeflanders_5km.csv"))

## Spatial object
write_sf(birdcube_data_out_sf,
         file.path(out_path, "birdcubeflanders_5km.gpkg"))
```
