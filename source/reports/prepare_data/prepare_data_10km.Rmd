...
query_abv <- "SELECT
  \"year\",
  GBIF_MGRSCode(10000, decimalLatitude, decimalLongitude, 0) AS mgrsCode,
  speciesKey,
  species,
  \"order\",
  family,
...
write_csv(abv_data_out,
          file.path(out_path, "abv_data_cube_10km_temp.csv"))

## Spatial object
write_sf(abv_data_out_sf,
         file.path(out_path, "abv_data_cube_10km_temp.gpkg"))

# Unstructured data
## CSV
write_csv(birdcube_data_out,
          file.path(out_path, "birdflanders_cube_10km_temp.csv"))

## Spatial object
write_sf(birdcube_data_out_sf,
         file.path(out_path, "birdflanders_cube_10km_temp.gpkg"))
```
