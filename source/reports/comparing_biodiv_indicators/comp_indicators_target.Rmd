...
store <- file.path(here::here(),
                   "source/pipelines/biodiversity_indicators/_targets")
...
total_occ_map_abv <- tar_read(total_occ_map_abv, store = store)
p <- plot(total_occ_map_abv)
p + labs(title = paste0(p$labels$title, " - ABV"))

total_occ_map_birdcube <- tar_read(total_occ_map_cube, store = store)
...
total_occ_ts_abv <- tar_read(total_occ_ts_abv, store = store)
p <- plot(total_occ_ts_abv)
p + labs(title = paste0(p$labels$title, " - ABV"))

total_occ_ts_birdcube <- tar_read(total_occ_ts_cube, store = store)
...
obs_richness_map_abv_1 <- tar_read(obs_richness_map_abv_1, store = store)
p <- plot(obs_richness_map_abv_1)
p + labs(title = paste0(p$labels$title, " - ABV"))

obs_richness_map_cube_1 <- tar_read(obs_richness_map_cube_1, store = store)
...
obs_richness_map_abv_10 <- tar_read(obs_richness_map_abv_10, store = store)
p <- plot(obs_richness_map_abv_10)
p + labs(title = paste0(p$labels$title, " - ABV"))

obs_richness_map_cube_10 <- tar_read(obs_richness_map_cube_10, store = store)
...
obs_richness_ts_abv <- tar_read(obs_richness_ts_abv, store = store)
p <- plot(obs_richness_ts_abv)
p + labs(title = paste0(p$labels$title, " - ABV"))

obs_richness_ts_cube <- tar_read(obs_richness_ts_cube, store = store)
...
spec_occ_map_abv <- tar_read(spec_occ_map_abv, store = store)
p <- plot(spec_occ_map_abv, species = "Cettia cetti")
p

spec_occ_map_cube <- tar_read(spec_occ_map_cube, store = store)
...
spec_occ_ts_abv <- tar_read(spec_occ_ts_abv, store = store)
p <- plot(spec_occ_ts_abv, species = "Cettia cetti")
p

spec_occ_ts_cube <- tar_read(spec_occ_ts_cube, store = store)
...
spec_range_map_abv <- tar_read(spec_range_map_abv, store = store)
p <- plot(spec_range_map_abv, species = "Cettia cetti")
p

spec_range_map_cube <- tar_read(spec_range_map_cube, store = store)
...
spec_range_ts_abv <- tar_read(spec_range_ts_abv, store = store)
p <- plot(spec_range_ts_abv, species = "Cettia cetti")
p

spec_range_ts_cube <- tar_read(spec_range_ts_cube, store = store)
