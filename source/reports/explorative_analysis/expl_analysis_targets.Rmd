...
fill_scale <- scale_fill_manual(
  name = "Category", values = my_colors
)
```
...
```{r}
shared_filter3_cyclus <- SharedData$new(tar_read(filter3, store = store) |>
                                          filter(species %in% species_list_cor,
                                                 id_spat_res == "1km",
                                                 id_filter_per == "cyclus"))
...
```{r}
shared_filter4_cyclus <- SharedData$new(tar_read(filter4, store = store) |>
                                          filter(species %in% species_list_cor,
                                                 id_spat_res == "1km",
                                                 id_filter_per == "cyclus",
                                                 id_filter_per2 == "cyclus"))
