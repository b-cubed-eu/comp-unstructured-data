...
store <- file.path(here::here(),
                   "source/pipelines/exploratory_analysis/_targets")
...
# ----- Save to file -----
ggsave(here::here("output", "data_exploration", "abv_three_panel.png"),
       final_plot,
...
# ----- Save to file -----
ggsave(here::here("output", "data_exploration", "cube_three_panel.png"),
       final_plot,
       width = 12, height = 10, dpi = 300)
```
...
```{r}
# ----- Save to file -----
ggsave(here::here("output", "data_exploration", "cube_coord_uncertainty.png"),
       coord_uncertainty,
