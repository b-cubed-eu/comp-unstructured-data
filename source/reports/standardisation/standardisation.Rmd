...
trend_comp_0 |>
  ...
  annotate("text",
           x = -1, y = 24.5,
           label = paste0("Mean without (very) rare species: ",
                          round(mean(trend_comp_0 |>
                                       filter(category %in% c("Common",
                                                              "Very common",
                                                              "Extremely common")) |>
                                       pull(correlation),
                                     na.rm = TRUE),2)),
...
trend_comp_0_cutoff |>
  ...
  annotate("text",
           x = -1, y = 24.5,
           label = paste0("Mean without (very) rare species: ",
                          round(mean(trend_comp_0_cutoff |>
                                       filter(category %in% c("Common",
                                                              "Very common",
                                                              "Extremely common")) |>
                                       pull(correlation),
...
trend_comp_3_cutoff |>
  ...
  annotate("text",
           x = -1, y = 24.5,
           label = paste0("Mean without (very) rare species: ",
                          round(mean(trend_comp_3_cutoff |>
                                       filter(category %in% c("Common",
                                                              "Very common",
                                                              "Extremely common")) |>
                                       pull(correlation),
...
#### 2007-2018 (based on where we see drop-off in data)
```{r}
tar_load(trend_comp_order_cutoff)
...
mutate(selected_species = ifelse(species %in% selected_species,
  ...
  annotate("text",
           x = -1, y = 24.5,
           label = paste0("Mean without (very) rare species: ",
                          round(mean(trend_comp_order_cutoff |>
                                       filter(category %in% c("Common",
                                                              "Very common",
                                                              "Extremely common")) |>
                                       pull(correlation),
...
#### 2007-2018 (based on where we see drop-off in data)
```{r}
tar_load(trend_comp_family_cutoff)
...
mutate(selected_species = ifelse(species %in% selected_species,
  ...
  annotate("text",
           x = -1, y = 24.5,
           label = paste0("Mean without (very) rare species: ",
                          round(mean(trend_comp_family_cutoff |>
                                       filter(category %in% c("Common",
                                                              "Very common",
                                                              "Extremely common")) |>
                                       pull(correlation),
...
#### 2007-2018 (based on where we see drop-off in data)
```{r}
tar_load(trend_comp_genus_cutoff)
...
mutate(selected_species = ifelse(species %in% selected_species,
  ...
  annotate("text",
           x = -1, y = 24.5,
           label = paste0("Mean without (very) rare species: ",
                          round(mean(trend_comp_genus_cutoff |>
                                       filter(category %in% c("Common",
                                                              "Very common",
                                                              "Extremely common")) |>
                                       pull(correlation),
